...
// End Cross Module References
	DEFINE_FUNCTION(APlayerCharacter::execSetPlayerHUDVisibility)
	{
	...
	DEFINE_FUNCTION(APlayerCharacter::execServerSprintEnd)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(APlayerCharacter::execServerSprintStart)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	IMPLEMENT_CLASS(APlayerCharacter, 1409931368);
