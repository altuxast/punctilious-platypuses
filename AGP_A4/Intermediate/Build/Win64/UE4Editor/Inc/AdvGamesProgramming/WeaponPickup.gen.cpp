...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AdvGamesProgramming_EWeaponPickupRarity_Hash() { return 2554428826U; }
	...
	DEFINE_FUNCTION(AWeaponPickup::execOnGenerate)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnGenerate();
	...
	IMPLEMENT_CLASS(AWeaponPickup, 532683969);
	...
	{
		static const FName Name_Rarity(TEXT("Rarity"));
		static const FName Name_BulletDamage(TEXT("BulletDamage"));
		static const FName Name_MuzzleVelocity(TEXT("MuzzleVelocity"));
		static const FName Name_MagazineSize(TEXT("MagazineSize"));
		static const FName Name_WeaponAccuracy(TEXT("WeaponAccuracy"));

		const bool bIsValid = true
			&& Name_Rarity == ClassReps[(int32)ENetFields_Private::Rarity].Property->GetFName()
			&& Name_BulletDamage == ClassReps[(int32)ENetFields_Private::BulletDamage].Property->GetFName()
			&& Name_MuzzleVelocity == ClassReps[(int32)ENetFields_Private::MuzzleVelocity].Property->GetFName()
			&& Name_MagazineSize == ClassReps[(int32)ENetFields_Private::MagazineSize].Property->GetFName()
			&& Name_WeaponAccuracy == ClassReps[(int32)ENetFields_Private::WeaponAccuracy].Property->GetFName();
