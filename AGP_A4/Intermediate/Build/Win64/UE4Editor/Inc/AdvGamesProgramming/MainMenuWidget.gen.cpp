...
// End Cross Module References
	DEFINE_FUNCTION(UMainMenuWidget::execOnQuitButtonPressed)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UMainMenuWidget::execOnJoinButtonPressed)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UMainMenuWidget::execOnHostButtonPressed)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	IMPLEMENT_CLASS(UMainMenuWidget, 1687108406);
