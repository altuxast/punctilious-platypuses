...
// End Cross Module References
	DEFINE_FUNCTION(APlayerHUD::execSetAmmoText)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_RoundsRemaining);
		P_GET_PROPERTY(FIntProperty,Z_Param_RoundsInMagazine);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APlayerHUD_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_APlayerHUD_SetAmmoText, "SetAmmoText" }, // 3722882934
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(APlayerHUD, 3011700864);
